          ...
          <View
            ...
            <View style={{flexDirection: 'column'}}>
              <TouchableOpacity
                ...
                <Text style={{...s.bold_label, color: 'white', marginLeft: 5}}>
                  {t('Set Payment')}
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
...
const PaymentModal = ({show, onClose, data, remainingamount = 600}) => {
  ...
  const onApply = () => {
    ...
    axios
      .put('/api/customer/', {
        sale_id: parseInt(data.receiptNumber, 10),
        ...
        <View style={{...inputS, flexDirection: 'row'}}>
          ...
          {paymentamount !== remainingamount ? (
            <TouchableOpacity
              ...
              onPress={() => setPayamount(remainingamount)}>
              <Text
...
export default CustomerVoucherView;
